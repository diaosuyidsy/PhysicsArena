...
Shader "Shield"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult28 = smoothstep( (0.2 + (_Energy - 0.0) * (-1.3 - 0.2) / (1.0 - 0.0)) , (2.0 + (_Energy - 0.0) * (1.0 - 2.0) / (1.0 - 0.0)) , tex2D( _TextureSample0, uv_TextureSample0 ).r);
...
/*ASEBEGIN
Version=17000
-20;554;1522;795;1461.939;355.9661;1.223813;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-368.421,358.7328;Float;False;Property;_Energy;Energy;9;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;90;37.9314,255.9841;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;2;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;89;-431.4081,154.0281;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.2;False;4;FLOAT;-1.3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;6;-872.9268,-243.221;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;0,0,0,0;0.4103766,0.833957,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SmoothstepOpNode;28;-254.8702,10.94893;Float;True;3;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=3E39D7599826B11CF4A7E1B28CECC06094BDEA63