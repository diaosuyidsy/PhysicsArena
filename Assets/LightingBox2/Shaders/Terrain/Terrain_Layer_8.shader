...
Shader "LightingBox/Terrain/Terrain 8-Layers"
{
	...
	SubShader
	{
		...
		uniform float4 _Specular_Color_7;
		uniform float4 _Specular_Color_8;
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float4 texArray173 = UNITY_SAMPLE_TEX2DARRAY_LOD(_AlbedoMaps, float3(( uv_AlbedoMaps20 * _UV_6 ), 6.0), 0 );
			float4 weightedBlendVar197 = tex2DNode138;
			float weightedBlend197 = ( weightedBlendVar197.x*texArray171.a + weightedBlendVar197.y*texArray172.a + weightedBlendVar197.z*texArray173.a + weightedBlendVar197.w*0.0 );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 texArray147 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_6 ), 14.0)  ) ,_Normal_Scale_7 );
			float3 texArray150 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_7 ), 14.0)  ) ,_Normal_Scale_8 );
			float4 weightedBlendVar159 = tex2DNode138;
			float3 weightedBlend159 = ( weightedBlendVar159.x*texArray141 + weightedBlendVar159.y*texArray144 + weightedBlendVar159.z*texArray147 + weightedBlendVar159.w*texArray150 );
			...
			float4 texArray173 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_6 ), 6.0)  );
			float4 texArray174 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_7 ), 7.0)  );
			float4 weightedBlendVar179 = tex2DNode138;
			float4 weightedBlend179 = ( weightedBlendVar179.x*texArray171 + weightedBlendVar179.y*texArray172 + weightedBlendVar179.z*texArray173 + weightedBlendVar179.w*texArray174 );
			...
			float4 weightedBlend189 = ( weightedBlendVar189.x*( _Specular_Color_5 * texArray171.g ) + weightedBlendVar189.y*( _Specular_Color_6 * texArray172.g ) + weightedBlendVar189.z*( _Specular_Color_7 * texArray173.g ) + weightedBlendVar189.w*( _Specular_Color_8 * texArray174.y ) );
			...
			float weightedBlend161 = ( weightedBlendVar161.x*( _Smoothness_5 * texArray171.r ) + weightedBlendVar161.y*( _Smoothness_6 * texArray172.r ) + weightedBlendVar161.z*( _Smoothness_7 * texArray173.r ) + weightedBlendVar161.w*( _Smoothness_8 * texArray174.x ) );
...
/*ASEBEGIN
Version=13501
7;29;1010;692;2804.445;4662.474;4.551686;True;False
Node;AmplifyShaderEditor.CommentaryNode;125;-2025.839,-1783.219;Float;False;1500.728;1727.471;Albedo;18;178;177;176;175;174;173;172;171;47;46;32;33;17;14;11;10;3;6;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;201;-6410.695,-2848.947;Float;False;Property;_UV_2;UV_2;25;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;203;-6410.696,-3004.833;Float;False;Property;_UV_1;UV_1;22;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;204;-6419.062,-3148.868;Float;False;Property;_UV_0;UV_0;19;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;202;-6410.694,-2700.985;Float;False;Property;_UV_3;UV_3;28;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;205;-6396.759,-2253.799;Float;False;Property;_UV_6;UV_6;24;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;207;-6396.76,-2409.686;Float;False;Property;_UV_5;UV_5;21;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.Vector2Node;208;-6405.126,-2553.721;Float;False;Property;_UV_4;UV_4;18;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.Vector2Node;206;-6396.758,-2105.838;Float;False;Property;_UV_7;UV_7;26;0;30,30;0;3;FLOAT2;FLOAT;FLOAT
Node;AmplifyShaderEditor.CommentaryNode;130;478.0417,656.0351;Float;False;1271.142;776.9246;Displacement;13;195;194;193;192;191;129;126;128;114;127;112;115;113;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;177;-1255.706,-484.6324;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2
...
Node;AmplifyShaderEditor.RangedFloatNode;191;537.1483,1231.367;Float;False;Property;_Displacement_7;Displacement_7;47;0;0;0;3;0;1;FLOAT
...
Node;AmplifyShaderEditor.TextureArrayNode;173;-952.5554,-509.6272;Float;True;Property;_TextureArray12;Texture Array 12;4;0;None;0;Instance;10;Auto;False;7;6;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT;6.0;False;2;FLOAT;0.0;False;3;FLOAT;1.0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;193;538.1483,1319.367;Float;False;Property;_Displacement_8;Displacement_8;48;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;194;540.1483,1144.367;Float;False;Property;_Displacement_6;Displacement_6;46;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;178;-1246.285,-274.941;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2
Node;AmplifyShaderEditor.RangedFloatNode;128;535.4833,969.0829;Float;False;Property;_Displacement_4;Displacement_4;44;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;114;541.3897,707.4896;Float;False;Property;_Displacement_1;Displacement_1;41;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.CommentaryNode;135;-3864.35,-4702.2;Float;False;1820.084;1642.141;Comment;24;147;146;145;144;143;142;141;140;139;96;133;109;95;94;107;131;108;132;110;106;148;149;150;200;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;124;-3728.566,326.5414;Float;False;889.2822;1491.483;Specular;18;189;188;187;186;185;184;183;182;181;90;88;86;87;89;82;83;81;80;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;126;538.4833,794.0829;Float;False;Property;_Displacement_2;Displacement_2;42;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.CommentaryNode;136;-1867.461,-2979.216;Float;False;1068.033;924.5947;Comment;18;169;168;167;166;165;164;163;162;161;76;77;78;71;74;72;73;75;79;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;127;535.4833,881.0829;Float;False;Property;_Displacement_3;Displacement_3;43;0;0;0;3;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;192;543.0546,1057.773;Float;False;Property;_Displacement_5;Displacement_5;45;0;0;0;3;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;145;-3015.936,-3466.367;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0.0,0;False;1;FLOAT2
Node;AmplifyShaderEditor.RangedFloatNode;110;-2750.775,-4537.538;Float;False;Property;_Normal_Scale_1;Normal_Scale_1;33;0;1;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;83;-3675.567,879.4498;Float;False;Property;_Specular_Color_4;Specular_Color_4;27;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2745.229,-3574.727;Float;False;Property;_Normal_Scale_6;Normal_Scale_6;38;0;0;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;146;-2752.52,-3389.847;Float;False;Property;_Normal_Scale_7;Normal_Scale_7;39;0;1;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;149;-2749.653,-3187.835;Float;False;Property;_Normal_Scale_8;Normal_Scale_8;40;0;1;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;140;-2744.24,-3769.399;Float;False;Property;_Normal_Scale_5;Normal_Scale_5;37;0;1;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;131;-2747.749,-4347.972;Float;False;Property;_Normal_Scale_2;Normal_Scale_2;34;0;1;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;132;-2743.087,-4156.866;Float;False;Property;_Normal_Scale_3;Normal_Scale_3;35;0;1;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;133;-2751.162,-3969.981;Float;False;Property;_Normal_Scale_4;Normal_Scale_4;36;0;1;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-1797.169,-2275.024;Float;False;Property;_Smoothness_7;Smoothness_7;15;0;0.5;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-1797.169,-2180.024;Float;False;Property;_Smoothness_8;Smoothness_8;16;0;0.5;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;148;-3016.773,-3256.126;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0.0,0;False;1;FLOAT2
...
Node;AmplifyShaderEditor.ColorNode;80;-3676.735,384.4427;Float;False;Property;_Specular_Color_1;Specular_Color_1;17;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;183;-3661.585,1606.291;Float;False;Property;_Specular_Color_8;Specular_Color_8;32;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ColorNode;82;-3678.567,718.4485;Float;False;Property;_Specular_Color_3;Specular_Color_3;23;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;182;-3665.243,1283.632;Float;False;Property;_Specular_Color_6;Specular_Color_6;30;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ColorNode;184;-3664.585,1445.289;Float;False;Property;_Specular_Color_7;Specular_Color_7;31;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.TextureArrayNode;174;-951.7917,-286.4938;Float;True;Property;_TextureArray13;Texture Array 13;5;0;None;0;Instance;10;Auto;False;7;6;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT;7.0;False;2;FLOAT;0.0;False;3;FLOAT;1.0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;181;-3662.67,1113.327;Float;False;Property;_Specular_Color_5;Specular_Color_5;29;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ColorNode;81;-3677.567,558.4481;Float;False;Property;_Specular_Color_2;Specular_Color_2;20;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;73;-1830.119,-2729.098;Float;False;Property;_Smoothness_3;Smoothness_3;11;0;0.5;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.TextureArrayNode;147;-2403.952,-3495.037;Float;True;Property;_TextureArray8;Texture Array 8;11;0;None;0;Instance;10;Auto;True;7;6;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT;14.0;False;2;FLOAT;0.0;False;3;FLOAT;1.0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;188;-3320.02,1448.033;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;185;-3326.736,1617.809;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;167;-1399.362,-2287.621;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.TextureArrayNode;150;-2404.486,-3293.189;Float;True;Property;_TextureArray9;Texture Array 9;11;0;None;0;Instance;10;Auto;True;7;6;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT;14.0;False;2;FLOAT;0.0;False;3;FLOAT;1.0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;166;-1395.462,-2185.241;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.SummedBlendNode;159;-1193.016,-3786.394;Float;False;5;0;COLOR;0,0,0,0;False;1;FLOAT3;0;False;2;FLOAT3;0.0,0,0;False;3;FLOAT3;0.0,0,0;False;4;FLOAT3;0.0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1995.239,-749.6547;Float;False;True;6;Float;ASEMaterialInspector;0;0;StandardSpecular;LightingBox/Terrain/Terrain 8-Layers;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;True;0;3;30;100;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;0;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=6F0694296AB4ACFD8C1F494E3A074A5094956661