...
Shader "Shield"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult28 = smoothstep( 0.2 , 1.0 , tex2D( _TextureSample0, uv_TextureSample0 ).r);
			float4 lerpResult13 = lerp( screenColor14 , ( _Color0 * 2.0 ) , smoothstepResult28);
			...
			c.rgb = ( lerpResult13 + ( ( 1.0 - step( length( (temp_cast_2 + (i.uv_texcoord - temp_cast_0) * (temp_cast_3 - temp_cast_2) / (temp_cast_1 - temp_cast_0)) ) , (0.15 + (_Energy - 0.0) * (1.0 - 0.15) / (1.0 - 0.0)) ) ) * ( _CrackColor * smoothstepResult18 ) ) ).rgb;
			c.a = ( 1.0 - Distance81 );
			return c;
		}
...
/*ASEBEGIN
Version=17000
89;501;1522;504;-308.3095;-975.853;1.235117;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;50;1244.137,663.1059;Float;False;Property;_RotateStrength;RotateStrength;8;0;Create;True;0;0;False;0;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-200.0932,676.8507;Float;False;Property;_CrackPower;CrackPower;3;0;Create;True;0;0;False;0;0;1.76;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-110.421,273.7328;Float;False;Property;_Energy;Energy;9;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;77;244.6137,308.4702;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.15;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;22;473.1618,429.4437;Float;False;Property;_CrackColor;CrackColor;4;1;[HDR];Create;True;0;0;False;0;0.1650943,0.6460097,1,0;0.6701568,2.884321,4,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-487.1469,7.006548;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;None;0a0ba8636ef5a7344a9e319bde3bde32;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;6;-872.9268,-243.221;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;0,0,0,0;0.4103768,0.833957,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;75;575.6137,305.4702;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;28;-151.9453,-103.7119;Float;True;3;0;FLOAT;0;False;1;FLOAT;0.2;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=432232F2D0D4BD5F91FDA5373F3F977CD4C5857B