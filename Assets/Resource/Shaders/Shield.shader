...
Shader "Shield"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float clampResult103 = clamp( (0.0 + (_Energy - 0.23) * (1.0 - 0.0) / (0.31 - 0.23)) , 0.0 , 1.0 );
			float4 lerpResult101 = lerp( _Color1 , _Color0 , clampResult103);
			float4 ifLocalVar99 = 0;
			if( _Energy >= 0.31 )
				ifLocalVar99 = _Color0;
			else
				ifLocalVar99 = lerpResult101;
			...
			float4 lerpResult13 = lerp( screenColor14 , ( ifLocalVar99 * 2.0 ) , clampResult88);
...
/*ASEBEGIN
Version=17000
6.4;1136;1524;747;1698.112;722.863;1.114728;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;41;1000.94,1234.948;Float;False;Property;_Range;Range;6;0;Create;True;0;0;False;0;0.82;0.09;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1340.674,913.1359;Float;False;Property;_Energy;Energy;10;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;102;-1223.728,-114.6972;Float;False;5;0;FLOAT;0.4;False;1;FLOAT;0.23;False;2;FLOAT;0.31;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;103;-1012.678,-79.84851;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;6;-1329.335,-491.0876;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;0,0,0,0;0.4103765,0.833957,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;45;1232.692,1236.466;Float;False;Property;_Distance;Distance;7;0;Create;True;0;0;False;0;10;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;15;-301.2099,479.1501;Float;True;Property;_TextureSample1;Texture Sample 1;3;0;Create;True;0;0;False;0;None;5047f7bc739bcbb4c9e978828c2cab4d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;50;1244.137,663.1059;Float;False;Property;_RotateStrength;RotateStrength;9;0;Create;True;0;0;False;0;1;5.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;100;-1319.61,-308.2305;Float;False;Property;_Color1;Color 1;2;0;Create;True;0;0;False;0;0,0,0,0;1,0.4575472,0.4925441,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;65;-827.6461,455.2829;Float;True;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;1,1;False;3;FLOAT2;-1,-1;False;4;FLOAT2;1,1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-200.0932,676.8507;Float;False;Property;_CrackPower;CrackPower;4;0;Create;True;0;0;False;0;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;101;-945.4631,-286.1182;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LengthOpNode;70;-506.0824,310.8868;Float;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ConditionalIfNode;93;-789.1377,825.1712;Float;False;False;5;0;FLOAT;0;False;1;FLOAT;0.41;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;47;1290.131,1497.213;Float;False;Property;_BreakDirection;BreakDirection;8;0;Create;True;0;0;False;0;0,0,0;3,8,3;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;22;452.5797,392.1387;Float;False;Property;_CrackColor;CrackColor;5;1;[HDR];Create;True;0;0;False;0;0.1650943,0.6460097,1,0;4,0.6701568,0.706503,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ConditionalIfNode;99;-634.8214,-372.4706;Float;False;False;5;0;FLOAT;0;False;1;FLOAT;0.31;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ScreenColorNode;14;-167.9787,-477.5878;Float;False;Global;_GrabScreen0;Grab Screen 0;2;0;Create;True;0;0;False;0;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;99;2;6;0
WireConnection;99;3;6;0
...
ASEEND*/
//CHKSM=95135B171632C56914689F897CA1B6486756B7F2